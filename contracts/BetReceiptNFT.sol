...
contract BetReceiptNFT is ERC721, Ownable {
    ...
    constructor() ERC721("GoalBet Receipt", "GBET") Ownable() {}
    ...
    function _buildSVGFooter(string memory amountStr, uint256 betId) internal pure returns (string memory) {
        return string(abi.encodePacked(
            ...
            '<text x="200" y="355" font-family="monospace" font-size="11" fill="#555" text-anchor="middle">X LAYER | GOALBET | BET #', betId.toString(), '</text>',
